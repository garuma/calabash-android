...
require 'calabash-android/steps/action_bar_steps'
...
require 'calabash-android/steps/fragment_steps'
require 'calabash-android/steps/list_steps'
require 'calabash-android/steps/location_steps'
require 'calabash-android/steps/map_steps'
require 'calabash-android/steps/navigation_steps'
require 'calabash-android/steps/preferences_steps'
